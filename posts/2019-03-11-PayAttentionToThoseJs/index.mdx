---
title: Pay attention to those js
description: 你应该注意的那些JS（相关）
date: 2019-03-11 12:35:00
published: true
cover: ./Alex Beattie.jpeg
coverAuthor: Alex Beattie
...
> [JS/Node 事件循环](https://rollawaypoint.github.io/2019/03/07/writeSomething/EventLoop/)
