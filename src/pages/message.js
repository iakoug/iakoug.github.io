      ...
      <Layout>
        ...
        <div className="container message-board">
          ...
          <div className="submit-message">
            <button onClick={this.submit} type="button" className="ant-btn ant-btn-primary" ant-click-animating-without-extra-node="false"><span>Comment</span></button>
          </div>
        </div>
      </Layout>
    )
