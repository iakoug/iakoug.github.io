...
description: fetch 系列第三篇`记录帖`，封装一个请求并发控制的库
date: 2019-06-13 14:20:00
published: true
cover: ./photo-1533594124935-d848a72fb016.jpeg
coverAuthor: Belinda Fewings
coverOriginalUrl: https://unsplash.com/photos/yR_llXzRCjg
---

fetch 系列第三篇`记录帖`，封装一个请求并发控制的库
