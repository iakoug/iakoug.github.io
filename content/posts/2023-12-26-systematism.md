...
特征提取就是你并没有记住这个“人”这个对大脑来说特别困难切抽象的事物，大脑存储的是这个人的一个个外在和内在特征：性别、身高、五官、头发颜色、肤色、胖瘦、动态体征等等
...
例如我们比较精通一门编程语言之后去学习另一门同类型编程语言会很容易，第二门的学习成本被第一门前置的知识大大的稀释了。
从特征提取的角度来回答：语言背后的基础概念都是统一的、设计思想都是大同小异的，只是一些语法、范式的差异
...
就像战争，局限于一隅之地是无法纵观全局战场的局势的，策者需要考虑整个战场的动态和局势，而不仅仅是局部战区的情况。只有全面了解整个战场，才能够制定更全面、更有效的战略
...
不只是说要简单的知道这些内容，而是这些东西是在我们进行思考的上下文中的，这里的差别很大
...
对于应用到具体的事情上，本文就是利用类似的方法进行构思的<br>
当我觉得我想将我看待事情和解决问题的方法总结出一些文字的时候，我基于我想要表达的观念梳理出一些核心的要素，对这些要素的内容进行清晰的阐释，而这个阐释希望是结构化的，从一些关键要素的提炼来分段解释，通过一些案例来支撑

这应该是一套方法论，可以运用到生活和工作方方面面的场景
